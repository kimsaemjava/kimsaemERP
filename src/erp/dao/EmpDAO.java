...
public interface EmpDAO {
	...
	MemberDTO readNew(String id, Connection con) throws SQLException;
	...
	ArrayList<MemberDTO> getTreeEmpList(String deptno, Connection con) throws SQLException;	// 부서별사원조회
}
