...
public class EmpDTO {
	...
	//업데이트용
	public EmpDTO(String id, String addr, String grade, int point, String deptno) {
		super();
		this.id = id;
		this.addr = addr;
		this.grade = grade;
	...
	//조회용
	public EmpDTO(String id, String pass, String name,
			String addr, Date hiredate, String grade,
			int point,	String deptno) {
		super();
		this.id = id;
		this.pass = pass;
		this.name = name;
