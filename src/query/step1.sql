...
insert into member values('9401023jang','1234','장동건','731111-1111111','1973/11/11','1','0','부장','팀장','3급20호봉','1999/10/01',null,'d001','재직','222-222','서울시 봉천구','좋은동네','02-858-1111','02-225-1111','010-111-2222','jang@naver.com','jang.jpg');
insert into member values('0111022kim','1234','김범룡','800521-1111111','1980/09/01','1','0','과장','팀장','4급20호봉','2007/02/27',null,'d002','재직','222-222','서울시 봉천구','좋은동네','02-858-1111','02-225-1111','010-111-3333','kbr@naver.com','kbr.jpg');
insert into member values('92115kim','1234','김서연','901012-1111111','1990/11/11','1','0','과장','팀장','4급20호봉','2010/10/01',null,'d003','재직','222-222','서울시 봉천구','좋은동네','02-858-1111','02-225-1111','010-111-4444','jang@naver.com','jang.jpg');
...
=> member의 기본데이터, job테이블의 job_category, menupath
=> 로그인 성공하면 content.jsp의 문자열을 job_category값으로변경
   로그인 성공 후에 각 job_id별로 정의된 menupath에서 view정보를 가져와 연결하기
   로그인 성공 후에 profile_photo에 등록된 이미지로 연결
   컬럼이 달라졌으므로 LoginServlet, LoginDAOImpl변경, LoginDTO를 생성
