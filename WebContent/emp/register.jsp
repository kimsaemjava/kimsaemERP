...
<body>
		...
		<form role="form" class="form-horizontal"
			...
			<fieldset>
				...
				<div class="form-group" style="padding: 40px">
					<p class="centered">
						<img src="/kimsaemERP/images/myphoto.jpg" id="userImage"
							style="width: 100px">
					</p>
					<div>
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" id="birthday" name="birthday"
							placeholder="생년월일" class="form-control" minlength="15">
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="phonehome" name="phonehome"
							placeholder="집전화" class="form-control" minlength="15" required>
				...
				<div class="form-group">
					...
					<div class="col-sm-5">
						<input type="text" id="phonecell" name="phonecell"
							placeholder="핸드폰번호" class="form-control" minlength="15" required>
	...
	<div>
		<a href="/serverweb/emp/list.do">회원목록보기</a>
	</div>
</body>
</html>