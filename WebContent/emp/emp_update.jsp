...
<body>
	<div class="container-fluid">
			<form role="form" class="form-horizontal" action="/serverweb/emp/update.do" method="post">
				<fieldset>
					<div id="legend">
					...
					<div class="form-group">
						...
						<div class="col-sm-3">
							<!-- 포인트를 이곳에 출력하세요 -->
							<input type="text" value="<%=user.getPoint() %>" name="point"/>
						</div>
					</div>
					<div class="form-group">
						<!-- 등급-->
						...
						<div class="col-sm-3">
							<!-- 등급을 이곳에 출력하세요 -->
							<input type="text" value="<%=user.getGrade() %>" name="grade"/>
						</div>
					</div>
					<div class="form-group">
						<!-- Button -->
