...
<body>
	<div class="list-group">
		...
		<a href="/kimsaemERP/getname.do?action=register"	
		class="list-group-item">인사등록</a> 
		<a href="/kimsaemERP/getname.do?action=tree" 
		class="list-group-item">부서조회</a>
		<a href="/kimsaemERP/getname.do?action=org" 
