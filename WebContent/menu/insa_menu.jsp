...
<!-- 		<a href="/kimsaemERP/view.html?menupath=/menu/insa_menu.jsp&viewpath=/emp/register.jsp"	class="list-group-item">인사등록</a> --> 
		<a href="/kimsaemERP/dept/getname.do?action=register"	class="list-group-item">인사등록</a> 
		<a href="/kimsaemERP/dept/getname.do?action=tree" class="list-group-item">부서조회</a>
